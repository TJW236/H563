...
/* Private defines -----------------------------------------------------------*/
#define MT1_CAL_EN_Pin GPIO_PIN_13
#define MT1_CAL_EN_GPIO_Port GPIOC
#define LED_Pin GPIO_PIN_14
#define LED_GPIO_Port GPIOC
#define nfault_Pin GPIO_PIN_15
#define nfault_GPIO_Port GPIOC
#define DRV_CSN_Pin GPIO_PIN_3
#define DRV_CSN_GPIO_Port GPIOC
#define MT1_CSN_Pin GPIO_PIN_4
#define MT1_CSN_GPIO_Port GPIOC
#define FDCAN_STB_Pin GPIO_PIN_13
